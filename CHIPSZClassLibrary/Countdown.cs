...
namespace CHIPSZClassLibrary
{
    ...
    public class Countdown : Model
    {
        ...
        {
            this.position = new Vec3( (Input.Head.position.x + 0.5f), (Input.Head.position.x + 0.5f), (Input.Head.position.x - 1f)); // top left
        ...
        public void Update()
        {
            ...
            //UI.WindowEnd();
            this.position = new Vec3((Input.Head.position.x + 0.5f), (Input.Head.position.x + 0.5f), (Input.Head.position.x - 1f)); 
